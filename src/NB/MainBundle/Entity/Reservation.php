...
class Reservation
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="NB\MainBundle\Entity\Voyages", cascade={"persist"})
     */
    private $voyages;
    ...
    /**
     * @ORM\ManyToOne(targetEntity="NB\MainBundle\Entity\PointEmbarquement", cascade={"persist"})
     */
     ...
     * @param mixed $voyages
     */
    public function setVoyages(Voyages $voyages)
    {
