...
class Contact extends \NB\MainBundle\Entity\Contact implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'NB\\MainBundle\\Entity\\Contact' . "\0" . 'id', '' . "\0" . 'NB\\MainBundle\\Entity\\Contact' . "\0" . 'nom', '' . "\0" . 'NB\\MainBundle\\Entity\\Contact' . "\0" . 'email', '' . "\0" . 'NB\\MainBundle\\Entity\\Contact' . "\0" . 'message', '' . "\0" . 'NB\\MainBundle\\Entity\\Contact' . "\0" . 'createdAt');
        }
