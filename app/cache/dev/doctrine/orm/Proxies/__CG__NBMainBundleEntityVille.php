...
class Ville extends \NB\MainBundle\Entity\Ville implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'NB\\MainBundle\\Entity\\Ville' . "\0" . 'id', '' . "\0" . 'NB\\MainBundle\\Entity\\Ville' . "\0" . 'nom', '' . "\0" . 'NB\\MainBundle\\Entity\\Ville' . "\0" . 'description', '' . "\0" . 'NB\\MainBundle\\Entity\\Ville' . "\0" . 'isActive', '' . "\0" . 'NB\\MainBundle\\Entity\\Ville' . "\0" . 'createdAt', '' . "\0" . 'NB\\MainBundle\\Entity\\Ville' . "\0" . 'updateAt', '' . "\0" . 'NB\\MainBundle\\Entity\\Ville' . "\0" . 'photo');
        }
