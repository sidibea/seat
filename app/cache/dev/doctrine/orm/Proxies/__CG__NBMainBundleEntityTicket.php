...
class Ticket extends \NB\MainBundle\Entity\Ticket implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'NB\\MainBundle\\Entity\\Ticket' . "\0" . 'id', '' . "\0" . 'NB\\MainBundle\\Entity\\Ticket' . "\0" . 'ticketNo', '' . "\0" . 'NB\\MainBundle\\Entity\\Ticket' . "\0" . 'nom', '' . "\0" . 'NB\\MainBundle\\Entity\\Ticket' . "\0" . 'email', '' . "\0" . 'NB\\MainBundle\\Entity\\Ticket' . "\0" . 'age', '' . "\0" . 'NB\\MainBundle\\Entity\\Ticket' . "\0" . 'gender', '' . "\0" . 'NB\\MainBundle\\Entity\\Ticket' . "\0" . 'telephone');
        }
    ...
    public function setTicketNo($ticketNo)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTicketNo', array($ticketNo));
    ...
    public function getTicketNo()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTicketNo', array());
