...
class appDevDebugProjectContainer extends Container
{
    ...
    /**
     * Gets the 'app.exception_controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \NBMainBundle\Controller\CustomExceptionController A NBMainBundle\Controller\CustomExceptionController instance.
     */
    protected function getApp_ExceptionControllerService()
    {
        return $this->services['app.exception_controller'] = new \NBMainBundle\Controller\CustomExceptionController($this->get('twig'), true);
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'next-bus.net', 'port' => NULL, 'dbname' => 'nextb9og_voyage', 'user' => 'nextb9og_fatou', 'password' => 'sorofing', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_e00b9f1d652b6f6a511efa6959b5754905294f4d5f62ea08a03dabf478113ba4');
